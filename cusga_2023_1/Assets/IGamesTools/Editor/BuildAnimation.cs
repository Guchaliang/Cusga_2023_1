...
public class BuildAnimation : EditorWindow 
{
    ...
    //生成出的Prefab的路径
	private static string PrefabPath = "Assets/IGamesTools/IGamesToolsResources/Prefabs";
	//生成出的AnimationController的路径
    private static string AnimationControllerPath = "Assets/IGamesTools/IGamesToolsResources/AnimationController";
	//生成出的Animation的路径
    private static string AnimationPath = "Assets/IGamesTools/IGamesToolsResources/Animation";
    //美术给的原始图片路径
    private static string ImagePath = Application.dataPath + "/IGamesTools/IGamesToolsRaw/BuildAnimation";
