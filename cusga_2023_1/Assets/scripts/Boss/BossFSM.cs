...
public class BossFSM : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        states.Add(StateType.Idle, new BossState(this));
        states.Add(StateType.Attack1, new BossAttack1State(this));
        states.Add(StateType.Attack2, new BossAttack2State(this));
        states.Add(StateType.Attack3, new BossAttack3State(this));
        states.Add(StateType.Attack4, new BossAttack4State(this));
        states.Add(StateType.Attack5, new BossAttack5State(this));
        states.Add(StateType.Attack6, new BossAttack6State(this));
        states.Add(StateType.Attack7, new BossAttack7State(this));
        states.Add(StateType.Attack8, new BossAttack8State(this));
        states.Add(StateType.GetHit, new BossGetHitState(this));
        states.Add(StateType.Death, new BossDeathState(this));
